          ...
          >
            ...
            <div className="h-full flex flex-col items-center mt-24 px-2 md:px-12">
              ...
              <div className="flex flex-col">
                {' '}
                <div className="lg:px-36 text-justify px-4 sm:px-12 md:px-24 flex flex-col gap-2 text-xl font-semibold">
                  Montaż systemu alarmowego to proces, który składa się z kilku
                  istotnych elementów, w tym centrali alarmowej, czujek,
                  manipulatorów, sygnalizatorów oraz innych niezbędnych
                  komponentów, zapewniających kompleksowe zabezpieczenie mienia.
                ...
                <div className="grid mt-12 sm:grid-cols-2">
                  <div className="px-12 flex items-cenetr justify-cenetr">
                    <svg
                      id="fi_2564736"
                    ...
                    >
                      <g>
                        ...
                        <g fill="#434343">
                          ...
                          <circle cx="106.146" cy="329.163" r="7.285"></circle>
                          <circle cx="137.366" cy="329.163" r="7.285"></circle>
                          <circle cx="168.585" cy="329.163" r="7.285"></circle>
                          <circle cx="199.805" cy="329.163" r="7.285"></circle>
                          <circle cx="74.927" cy="358.301" r="7.285"></circle>
                          <circle cx="106.146" cy="358.301" r="7.285"></circle>
                          <circle cx="137.366" cy="358.301" r="7.285"></circle>
                          <circle cx="168.585" cy="358.301" r="7.285"></circle>
                          <circle cx="199.805" cy="358.301" r="7.285"></circle>
                        </g>
                        <g>
                          <g>
                            <path
